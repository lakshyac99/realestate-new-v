...
const Overview = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      description:
        "Add 5 or more phots plus a title and description - we'll help you out.",
      image: "/overview2.webp",
    },
    {
      title: "Finsh up and publish",
      description:
  ...
  return (
    <div className="flex h-full justify-center items-center px-32 gap-20">
      <div>
        <strong>
